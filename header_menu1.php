            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <a href="index.php" class="navbar-brand">
						<img src="img/logo.png" class="img-fluid rounded-circle"  style="width: 200px; height: 200px;" alt="">
                    </a>
					</div>
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        ...
                        <div class="d-flex m-3 me-0">
							<a href="signup.php" class="btn active btn border border-secondary rounded-pill px-3 text-primary">
                                Sign up
                                <span class="" style="top: -5px; left: 15px; height: 20px; min-width: 20px;"></span>
                            </a>&nbsp&nbsp&nbsp&nbsp
							<a href="login.php" class="btn border border-secondary rounded-pill px-3 text-primary">
                                Login
                                <span class="" style="top: -5px; left: 15px; height: 20px; min-width: 20px;"></span>
                            </a>&nbsp&nbsp&nbsp&nbsp
