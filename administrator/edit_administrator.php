                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
								...
								<ul id="myTabedu1" class="tab-review-design">
										<li class="active"><a href="#description">Edit Administrator </a></li>
									</ul>
                                   <!-- 
                                    <h1 style="color:blue">Administrators <span class="table-project-n">Data</span></h1>-->
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="email" data-editable="true">Contact Number</th>
                                                <th data-field="phone" data-editable="true">Email Id</th>
											...
											<?php 					
												...
												$result = array();
														...
														while($row = mysqli_fetch_array($res))
													{
														...
														echo $row['adm_mob']; 
														print "</td> <td>";
														echo $row['adm_mail_id'];
														print "</td><td>";
														$temp = "./update_administrator.php?adm_id=".$row['adm_id'];
														...
														$temp = "./delete_administrator_code.php?adm_id=".$row['adm_id'];
